...
import ExperienceRichDetail from "@/components/experience/experience-rich-detail";
...
export async function generateMetadata({
  ...
  return {
    title: experience.company
      ? `${experience.position} at ${experience.company} | Experience`
      : `${experience.position} | Experience`,
    description: experience.company
      ? `Detailed information about my role as ${experience.position} at ${experience.company}.`
      : `Detailed information about my role as ${experience.position}.`,
    alternates: {
        ...
        <AnimatedSection delay={0.3}>
          <div>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              {experience.company
                ? `These are the primary technologies and skills utilized during my time at ${experience.company}.`
                : "These are the primary technologies and skills utilized in this role."}
            </p>
          </div>
        </AnimatedSection>
      ),
