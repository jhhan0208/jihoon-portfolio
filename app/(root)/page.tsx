...
import { getFeaturedAchievements } from "@/config/achievements";
import { experiences } from "@/config/experience";
import { homepageFeaturedSkills } from "@/config/homepage-featured-skills";
  ...
  return (
    <ClientPageWrapper>
      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-12">
          <Image
            ...
            alt={`${siteConfig.authorName} - ${siteConfig.jobTitle} Portfolio`}
            priority
          />
          <AnimatedText
            as="h1"
          ...
          <div className="flex flex-col mt-5 items-center justify-center sm:flex-row sm:flex-wrap sm:justify-center gap-3">
            ...
            <AnimatedText delay={1.0}>
              ...
              >
                <Icons.youtube className="w-4 h-4 mr-2" /> Youtube
              </Link>
            </AnimatedText>
          ...
          <AnimatedText delay={1.2}>
            <Icons.chevronDown className="h-6 w-6 mt-4 text-muted-foreground" />
          </AnimatedText>
        </div>
      </section>
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          <AnimatedText
            ...
            className="font-heading text-3xl leading-[1.1] sm:text-3xl md:text-6xl"
          >
            {pagesConfig.achievements.title}
          </AnimatedText>
          <AnimatedText
            as="p"
            delay={0.2}
            className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7"
          >
            {pagesConfig.achievements.description}
          </AnimatedText>
        </div>
      ...
      >
        ...
        <SkillsCard skills={homepageFeaturedSkills} />
        <AnimatedText delay={0.4} className="flex justify-center">
          <Link href="/skills">
            <Button variant={"outline"} className="rounded-xl">
              <Icons.chevronDown className="mr-2 h-4 w-4" /> View All
